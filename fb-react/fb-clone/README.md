...
# npx create-react-app fb-react
create a cluster in MongoDB (login with gmail and create a free cluster, no need to do any configuration at this point)
...
In Database Access, create a user (admin) and below is the password:
Y36WPXjFsXtSKYDa
-----------------
...
Also, add "start": "node server.js" under "scripts"